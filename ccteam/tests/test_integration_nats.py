...
These tests are skipped unless ``CCTEAM_NATS_URL`` points at a
...
from ccteam import checkpoint, cluster, config, dlm, manifest, nats_client, node, overlay
from ccteam.dlm import LockMode


NATS_URL = os.environ.get("CCTEAM_NATS_URL")
pytestmark = pytest.mark.skipif(NATS_URL is None, reason="CCTEAM_NATS_URL not set")
